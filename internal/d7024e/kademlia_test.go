...
func TestLookupContact(t *testing.T) {
	...
	meid := NewRandomKademliaID()
	id1 := NewRandomKademliaID()
	id2 := NewRandomKademliaID()
	id3 := NewRandomKademliaID()
	id4 := NewRandomKademliaID()
	id5 := NewRandomKademliaID()
	id6 := NewRandomKademliaID()
	id7 := NewRandomKademliaID()
	id8 := NewRandomKademliaID()
	id9 := NewRandomKademliaID()
	// id10 := NewRandomKademliaID()
	// id11 := NewRandomKademliaID()
	// id12 := NewRandomKademliaID()
	// id13 := NewRandomKademliaID()
	// id14 := NewRandomKademliaID()
	// id15 := NewRandomKademliaID()
	// id16 := NewRandomKademliaID()
	// id17 := NewRandomKademliaID()
	// id18 := NewRandomKademliaID()
	// id19 := NewRandomKademliaID()
	// id20 := NewRandomKademliaID()
	// id21 := NewRandomKademliaID()
	// id22 := NewRandomKademliaID()
	// id23 := NewRandomKademliaID()
	// id24 := NewRandomKademliaID()
	// id25 := NewRandomKademliaID()
	...
	// shortlistJSON := kademlia.LookupContact(&con17)
	// shortlist := network.KTriples(shortlistJSON)
	// assert.Equal(t, con17.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con1)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con1.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con2)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con2.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con3)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con3.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con4)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con4.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con5)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con5.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con6)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con6.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con7)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con7.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con8)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con8.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con9)
	// assert.Equal(t, con9.ID, shortlist[0].ID)
	// shortlistJSON := kademlia.LookupContact(&con10)
	// shortlist := network.KTriples(shortlistJSON)
	// assert.Equal(t, con10.ID, shortlist[0].ID)
	// shortlist = network.KTriples(shortlistJSON)
	//
	// shortlistJSON = kademlia.LookupContact(&con18)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con18.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con19)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con19.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con20)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con20.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con21)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con21.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con22)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con22.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con23)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con23.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con24)
	// shortlist = network.KTriples(shortlistJSON)
	// assert.Equal(t, con24.ID, shortlist[0].ID)
	// shortlistJSON = kademlia.LookupContact(&con25)
	// shortlist = network.KTriples(shortlistJSON)
